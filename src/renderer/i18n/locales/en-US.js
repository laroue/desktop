export default {
  ...
  INTRODUCTION: {
    ...
    TURN: {
      TITLE: 'Your Turn',
      KNOWLEDGE: 'Now, armed with the knowledge of how important it is to keep your passphrases safe, you are ready to claim your financial autonomy with the Desktop Wallet.',
      SUPPORT: 'ARK is an open-source ecosystem and if you need assistance, the community and team is here to help. Create a post on reddit.ark.io, or join the real-time chat system at slack.ark.io.',
      CONCLUSION: 'Everyone here on the ARK.io team hopes you enjoy using the Desktop Wallet to participate in the blockchain revolution!'
    }
  },
