export default {
  COMMON: {
    ADDRESS: 'Adresse',
    ALL: 'Tout',
    APP_NAME: 'Portfeuille de Bureau',
    APP_NAME_SHORT: 'Portfeuille',
  ...
  INTRODUCTION: {
    ...
    RESPONSIBILITY: {
      ...
      STORAGE: {
        EXPLANATION: 'La {PASSPHRASE} de chaque adresse de portefeuille est capable de signer des transactions et de transférer des fonds. Cela signifie que si votre ordinateur tombe en panne mais que vous avez votre phrase secrète, vous pouvez toujours accéder à vos fonds. Le portefeuille de bureau comporte une fonctionnalité supplémentaire qui vous permet également de définir un {ENCRYPTED}, pour une gestion plus facile. Si votre ordinateur est défaillant, vous ne pouvez pas utiliser le mot de passe crypté pour accéder à vos fonds depuis un autre ordinateur. {NEED}.',
    ...
    TURN: {
      TITLE: 'A votre tour',
      KNOWLEDGE: 'Maintenant, sachant à quel point il est important de protéger vos phrases secrètes, vous êtes prêt à revendiquer votre autonomie financière avec le portefeuille de bureau.',
      SUPPORT: 'MLC est un écosystème open-source. Si vous avez besoin d\'aide, la communauté et son équipe sont à votre disposition. Créez un post sur reddit.laroue.org ou rejoignez le système de discussion en temps réel à l\'adresse slack.laroue.org.',
      CONCLUSION: 'Tous les membres de l\'équipe espèrent que vous apprécierez l\'utilisation du portefeuille de bureau pour participer à la révolution de la blockchain !'
    }
  },
  ...
  ENCRYPTION: {
    ...
    FAILED_ENCRYPT: 'Impossible de chiffrer la phrase secrète'
  },
  ...
  VALIDATION: {
    ...
    NOT_VALID: 'Le \'{0}\' n\'est pas valide',
    NOT_NUMERIC: 'Le \'{0}\' n\'est pas numérique',
    NO_SCHEME: 'Le \'{0}\' n\'a pas de \'http://\' ou de \'https://\'',
    NAME: {
    ...
    VENDOR_FIELD: {
      LIMIT_REACHED: 'Vous pouvez saisir seulement {0} caractères au maximum'
    },
  ...
  APP_FOOTER: {
    TEXT: 'Fabriqué avec ♥ par La Roue'
  },
  ...
  INPUT_DELEGATE: {
    ERROR: {
      REQUIRED: 'Le nom du délégué, l\'adresse ou la clé publique est obligatoire',
      USERNAME_NOT_FOUND: 'Le délégué \'{0}\' n\'a pas pu être trouvé',
      ADDRESS_NOT_FOUND: 'Le délégué avec l\'adresse \'{0}\' n\'a pas pu être trouvé',
      PUBLIC_KEY_NOT_FOUND: 'Le délégué avec la clé publique \'{0}\' n\'a pas pu être trouvé'
    },
    SEARCH_HINT: 'Vous pouvez rechercher par nom d\'utilisateur, adresse ou clé publique'
  },
  ...
  MODAL_ADDITIONAL_LEDGERS: {
    CANCEL: 'Annuler',
    INFO: 'Choisissez le nombre maximum de portefeuilles Ledger que vous souhaitez afficher. Vous affichez actuellement {quantity} portefeuilles.',
    LARGE_QUANTITY: 'Vous essayez de charger un grand nombre de portefeuilles. Cela pourrait ralentir le chargement ou prolonger le délai de péremption de l\'appareil.',
    LOAD: 'Charger les portefeuilles',
    QUANTITY: 'Quantité',
    TITLE: 'Charger les portefeuilles Ledger additionnels'
  },
  ...
  PAGES: {
    ...
    WALLET_EXCHANGE: {
      CHANGELLY_TERMS: {
        TITLE: 'Achetez des {ticker} directement dans le portefeuille de bureau avec notre intégration Changelly',
        CONTENT: 'Changelly vous permet d\'échanger d\'autres crypto-devises en {ticker} et vous offre la possibilité d\'acheter des {ticker} directement avec vos cartes de crédit ou de débit.',
    ...
    WALLET_ALL: {
      LEDGER: {
        CACHE: 'Mettre les portefeuilles en cache ?',
        CACHE_INFO: 'Mettre en cache les portefeuilles de votre livre pour accélérer le chargement lors de la première connexion',
        ADDITIONAL: '# portefeuilles de grand livre'
      },
      CREATE_WALLET: 'Créer un portefeuille',
  ...
  WALLET_DELEGATES: {
    ...
    VOTE_INFO: 'Info :',
    NO_VOTE: 'Ce portefeuille ne vote pas. Pour afficher plus d\'informations et voter, utilisez la recherche ou cliquez sur un délégué.',
    AWAITING_VOTE_CONFIRMATION: 'Votre {type} est en attente de confirmation',
    LOADING_VOTE: 'Chargement des détails du vote ...',
    SEARCH_DELEGATE: 'Recherche de délégué'
  },
